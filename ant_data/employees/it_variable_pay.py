...
from ant_data.employees import hierarchy, hard_shopkeeper_days
...
def df(hierarchy_id, agent, start, end):
  ...
  hard_days1 = hard_shopkeeper_days.df(client_ids, month1_dt, end_dt)
  hard_days2 = hard_shopkeeper_days.df(client_ids, month2_dt, month1_dt)
  hard_days3 = hard_shopkeeper_days.df(client_ids, month3_dt, month2_dt)
