...
Notes:        
==========================
- v1.0: Initial version based on systems_open__model
"""
...
from ant_data.installs import installs_closed__model, installs_opened__model
...
def df_start(country, f=None, interval='month'):
  ...
  opened = installs_opened__model.df(country, f=f, interval=interval)
  closed = installs_closed__model.df(country, f=f, interval=interval)
