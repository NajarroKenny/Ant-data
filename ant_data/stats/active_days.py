...
Warehouse to generate a report on client active days during a regerence period.
...
def search(country, f=None, interval='month'):
    ...
    s.aggs.bucket('color30', 'histogram', field='stats.ur30', interval=0.05)
    s.aggs.bucket('color60', 'histogram', field='stats.ur60', interval=0.05)
    s.aggs.bucket('color90', 'histogram', field='stats.ur90', interval=0.05)
    s.aggs.bucket('color180', 'histogram', field='stats.ur180', interval=0.05)
    s.aggs.bucket('color360', 'histogram', field='stats.ur360', interval=0.05)
